...
export default function VerificationOfficerDashboard() {
  ...
  const cardData = [
    { title: "Profile", icon: "👤", href: "/verification_officer_login/profile", ariaLabel: "View User Profile", styleKey: "profile" },
    { title: "Voucher", icon: "📄", href: "/verification_officer_login/view_voucher", ariaLabel: "View and Process Vouchers", styleKey: "voucher" },
  ];
